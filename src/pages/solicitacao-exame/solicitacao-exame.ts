...
@IonicPage()
@Component({
  selector: 'page-solicitacao-exame',
  templateUrl: 'solicitacao-exame.html',
})
export class SolicitacaoExamePage {
  ...
  solicitarExame() {
    ...
    let dados = { paciente_id: this.paciente_id, exame: this.exame,
    			  data: this.data, turno: this.turno };
    			  
    this.api.solicitarExame(dados).subscribe(
      (data) => { 
